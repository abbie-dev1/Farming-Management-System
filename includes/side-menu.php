<div class="sidebar-menu">
    ...
    if(isset($_SESSION)) {
        if ($_SESSION['user'] == 'farmer') {
            ...
            <a href='#' class='editFarmer'><div class='side-options profile'>Update Profile <i class='fa fa-edit'></i></div></a>
            ...
            <div class='half-sidebar'>
               <a href='#' id='track_all' class='anim_trace'><div class='side-options'><i class='fa fa-location-arrow'></i></div></a>
                ...
                <a href='#' class='editFarmer'><div class='side-options profile'><i class='fa fa-edit'></i></div></a>
            ...
            <a href='../admin/admin.php'><div class='side-options'>Admins <i class='fa fa-user'></i></div></a>
            <a href='../admin/farmer.php'><div class='side-options'>Farmers <i class='fa fa-users'></i></div></a>
         
            <a href='#' ><div class='side-options profile'>Update Profile <i class='fa fa-edit'></i></div></a>
            <a href='../admin/reports.php'><div class='side-options'>Reports <i class='fa fa-bookmark'></i></div></a>
            <a href='../logout.php'><div class='side-options'>Logout <i class='glyphicon glyphicon-log-in'></i></div></a>
            </div>
            <div class='half-sidebar'>
               <a href='../admin/admin.php'><div class='side-options'><i class='fa fa-user'></i></div></a>
                <a href='../admin/farmer.php'><div class='side-options'><i class='fa fa-users'></i></div></a>
                <a ><div class='side-options profile'><i class='fa fa-edit'></i></div></a>
                <a href='../admin/reports.ph'><div class='side-options'><i class='fa fa-bookmark'></i></div></a>
                <a href='../logout.php'><div class='side-options'><i class='glyphicon glyphicon-log-in'></i></div></a>
            </div> 
            ";
        }
