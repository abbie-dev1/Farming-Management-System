...
<body id="page-top">
    ...
    <header class="masthead" style="background-image:url('./../images/hot desk/bg_hotdesk.jpg');">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in"><span>Welcome To Hot desk Luxury Venues!</span></div>
