...
<?php include 'includes/session.php'; ?>
    ...
    <header class="masthead" style="background-image:url('./../images/banner_img.png');">
        <div class="container">
            ...
            <?php
                ...
                <div class="intro-heading text-uppercase"></div>
                 <form class="bootstrap-form-with-validation" action="signup.php" method="POST" onsubmit="sendForm();" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label for="companyName">Company Name</label><input class="form-control" type="text" id="companyName" name="companyName" placeholder="Enter your Company name" onkeypress="return i.test(event.key)" required></div>
                    <div class="form-group"><label for="companyNo">Company Reg no.</label><input class="form-control" type="text" id="companyNo" name="companyNo" placeholder="Company number"onkeypress="return i.test(event.key)" required></div>
                    <div class="form-group"><label for="pNumber">Contact no.</label><input class="form-control" type="text" id="pNumber" name="pNumber"  placeholder="Cellphone no." onkeypress="return i.test(event.key)" onkeyup="ValueKeyPress('mobile');" required></div>
                     <span id="verify"></span>
                    <div class="form-group"><label for="address">Address</label><input class="form-control" type="text" id="address" name="address" placeholder="Your address" onkeypress="return i.test(event.key)" required></div>
                    ...
                    <div class="form-group"><label for="bankDetails">Bank Details</label><input class="form-control inputTxt" type="text" id="bankDetails" name="bankDetails" placeholder="Enter your bankDetails" onkeypress="return i.test(event.key)" required></div>
                    <div class="form-group"><label for="idCopy">Attach Copy Id</label><input class="form-control inputTxt" type="file" id="idCopy" name="photo" class="input-file" required></div>
